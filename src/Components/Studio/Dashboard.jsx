...
function Dashboard() {
  ...
  useEffect(() => {
    const getSubscribers = async () => {
      try {
        if (Email !== undefined) {
          const response = await fetch(`${backendURL}/getsubscribers/${Email}`);
        ...
        <div className="studio-dashboard-section">
          ...
          >
            ...
            <div className="dash-data-all">
              ...
              {/*======= empty video hoy to aa card batavse jem badhi deatils empty  ===========*/}
